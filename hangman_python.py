...
def findInstances(char, string): #finds instances of char in string and returns a list of where the instances were
    ...
    #then this will add the instances of that string into a list [instances]
